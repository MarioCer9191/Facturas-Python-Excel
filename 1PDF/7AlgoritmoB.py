...
CSV_SALIDA = os.path.join(RAIZ, "1PDF", "PDFCategory_B.csv")  # Salida ajustada
...
# ================================
# Asignar categoría usando solo coincidencias exactas en NombreEmisor
# ================================
def asignar_categoria_fila(fila, diccionario):
    texto_emisor = str(fila.get("NombreEmisor", "") or "")
    coincidencias = Counter()

    for categoria, palabras in diccionario.items():
        for palabra in palabras:
            if palabra in texto_emisor:
